  ...
  return (
    <label className="block w-full">
      ...
      <div className="relative">
        <input
          className={`w-full rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 outline-none ring-cyan-500/20 transition placeholder:text-zinc-500 focus:ring-2 ${className}`}
          {...props}
        />
